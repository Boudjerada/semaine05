...
if  (isset ($_SESSION["status"])){
    ...
    if (isset ($_SESSION["enrcontactok"])){
        echo' <script> alert("Vôtre demande a était prise en compte"); </script>';
    }
...
?>
        ...
        <?php echo form_open(); ?>
            <div class="form-group">
                <label for="Nom"><b>Nom*</b></label><input type="text" class="form-control" name="Nom" id="Nom"  value="<?=set_value('Nom');?>" placeholder="Veuillez saisir votre nom" > <!--formcontrol pour mettre la zone de saisie en dessous du titre du champs-->
                <span id="alerte-nom" class="text-danger"><?php if  (isset ($_SESSION["messNom"])) echo $_SESSION["messNom"];?> </span>
                <br>
                <label for="Prenom"><b>Prénom*</b></label><input type="text" class="form-control" name="Prenom" id="Prenom"   value="<?=set_value('Prenom');?>" placeholder="Veuillez saisir votre prénom">
            ...
            <div class="form-group">
                <label for="date"><b>Date de naissance*</b></label><input type="text" class="form-control" name="date" id="date"  value="<?=set_value('date');?>"  placeholder="Veuillez saisir votre date de naissance">
                <span id="alerte-date" class="text-danger"><?php if  (isset ($_SESSION["messDate"])) echo $_SESSION["messDate"];?> </span>
                <br>
                <label for="CodePostal"><b>Code postal*</b></label><input type="number" class="form-control" name="CodePostal" id="CodePostal"  value="<?=set_value('CodePostal');?>"  placeholder="Veuillez saisir votre code postal">
                <span id="alerte-codep" class="text-danger"><?php if  (isset ($_SESSION["messCp"])) echo $_SESSION["messCp"];?> </span>
                <br>
                <label for="Adresse"><b>Adresse*</b></label><input type="text" class="form-control" name="Adresse" id="Adresse"  value="<?=set_value('Adresse');?>"  placeholder="Veuillez saisir votre adresse">
                <span id="alerte-adresse" class="text-danger"><?php if  (isset ($_SESSION["messAdr"])) echo $_SESSION["messAdr"];?> </span>
                <br>
                <br>
                <label for="Ville"><b>Ville*</b></label><input type="text" class="form-control" name="Ville" id="Ville"  value="<?=set_value('Ville');?>"  placeholder="Veuillez saisir votre ville">
                <span id="alerte-ville" class="text-danger"><?php if  (isset ($_SESSION["messVille"])) echo $_SESSION["messVille"];?> </span>
                <br>
                <br>
                <label for="courriel"><b>Email*</b></label><input type="email" class="form-control" name="courriel" id="courriel"  value="<?=set_value('courriel');?>" placeholder="date.loper@afpa.fr" >
            ...
            <h1><b>Votre demande</b></h1>
                ...
                <br>
                <p>Votre question*:</p>
                <textarea for="question" name="question" class="form-control ml-1 row col-12 col-sm-12" id="question" rows="3"><?=set_value('question');?></textarea>
